...
int main(int argc, char** argv)
{
  ...
  if (argc != 2){
   ...
   fp=fopen("/home/dicecco1/caffe_sdaccel_layers/LRN_FINAL/WC/LRN_WC/test.txt","r");
  ...
  //
  kernel = clCreateKernel(program, "lrn1_wc_float", &err);
  ...
  clWaitForEvents(1, &readevent);
   ...
   fp=fopen("/home/dicecco1/caffe_sdaccel_layers/LRN_FINAL/WC/LRN_WC/sw_vals.dat", "r");
    for (x=0;x<OSIZE;x++) {
         fscanf(fp, "%f", &tmp);
         swout[x]=tmp;
    }
