...
int main(int argc, char** argv)
{
  ...
  if (argc != 2){
   ...
   fp=fopen("/home/mahade15/sdaccel/Pooling_SDAccel/ave/test.dat","r");
...
*/
  ...
  //
  kernel = clCreateKernel(program, "pool2_ave_float", &err);
  ...
  // Validate our results
   ...
   fp=fopen("/home/mahade15/sdaccel/Pooling_SDAccel/ave/sw_vals.dat", "r");
   for (x=0;x<OWIDTH;x++) {
     for (y=0; y<OHEIGHT; y++) {
       fscanf(fp, "%f", &tmp);
       sw_out[x][y]=tmp;
